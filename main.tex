...
\node (b2) [right=of b, minimum height = 1.5em] {$x_{j+1}$};
...
\begin{itemize}
\item In HMMs and PCFGs, simply replace $\Psi = UV^\top$
\vspace{1em}
...
\begin{itemize}
\item Represent the dynamic program used for exact inference with a hypergraph
