...
\begin{itemize}
\item Introduce a low-rank factorization to speed up marginalization in hypergraph models
\vspace{2em}
\item Constrain only parameters used in marginalization bottlenecks
\vspace{2em}
